...
const Logo: FC<LogoProps> = ({ height, theme }) => {
  const { theme: realTheme } = useContext(ThemeContext);
  const primaryColor = (theme ?? realTheme) === Theme.Light ? '#000' : '#fff';
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 255.85 77.92" style={{ height: `${height ?? 32}px` }}>
      <path
        ...
        fill={primaryColor}
      />
      <path d="M49.95 62.27L72.44.2h4L53.95 62.27z" fill={palette.color.orange} />
      <path
